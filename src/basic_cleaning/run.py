...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = 'This is the input_artifact',
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = 'This is the output_artifact',
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = 'This is the output_description',
        required = True
    )
